...
int main() {
    ...
    // -------------------------
    Shader flashLightShader("flashLight.vert", "flashLight.frag");
    ...
    flashLightShader.setInt("material.diffuse", 0);
    flashLightShader.setInt("material.specular", 1);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        flashLightShader.setFloat("light.cutOff",   glm::cos(glm::radians(12.0f)));
        flashLightShader.setFloat("light.outerCutOff",   glm::cos(glm::radians(18.0f)));
        flashLightShader.setVec3("viewPos", camera.Position);

        // light properties
        flashLightShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f);
        flashLightShader.setVec3("light.diffuse", 1.5f, 1.5f, 1.5f);
        flashLightShader.setVec3("light.specular", 2.0f, 2.0f, 2.0f);
