...
int main() {
    ...
    // -------------------------
    Shader lightingShader("multiLightSource.vert", "multiLightSource.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        */
        ...
        lightingShader.setFloat("pointLights[3].linear", 0.2);
        ...
        lightingShader.setVec3("spotLight.specular", 1.5f, 1.5f, 1.5f);
